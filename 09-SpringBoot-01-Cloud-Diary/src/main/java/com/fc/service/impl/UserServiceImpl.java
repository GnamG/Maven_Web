...
public class UserServiceImpl implements UserService {
    ...
    public Integer checkNick(String nick) {
        ...
        List<TbUser> nicks = tbUserDao.selectByExample(example);
        return nicks.size();
    }
    ...
    public ResultVO update(MultipartFile img, TbUser user) {
        ...
        if (img!=null&& !img.isEmpty()) {
            String path = "D:\\idea_code\\09-SpringBoot-01-Cloud-Diary\\target\\classes\\META-INF\\resources\\upload";
